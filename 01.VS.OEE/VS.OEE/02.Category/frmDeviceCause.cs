...
namespace VS.OEE
{
    public partial class frmDeviceCause : DevExpress.XtraEditors.XtraForm
    {
        private static int iPQ =1;
        public frmDeviceCause(int iPQCN)
        {
            iPQ = iPQCN;
            InitializeComponent();
            Commons.Modules.ObjSystems.ThayDoiNN(this);
        }
        private void frmDeviceCause_Load(object sender, EventArgs e)
        {
            VisibleButon(true);
