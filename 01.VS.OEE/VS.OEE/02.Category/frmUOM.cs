...
namespace VS.OEE
{
    public partial class frmUOM : DevExpress.XtraEditors.XtraForm
    {
        ...
        void composLink_CreateMarginalHeaderArea(object sender, CreateAreaEventArgs e)
        {
            ...
            e.Graph.DrawString(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "frmUOM" , "bcTieuDeUOM", Commons.Modules.TypeLanguage), Color.Black, rec, BorderSide.None);
