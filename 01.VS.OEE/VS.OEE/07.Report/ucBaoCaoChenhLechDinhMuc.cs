...
namespace VS.OEE
{
    public partial class ucBaoCaoChenhLechDinhMuc : DevExpress.XtraEditors.XtraUserControl
    {
        public ucBaoCaoChenhLechDinhMuc()
        {
            InitializeComponent();
            Commons.Modules.ObjSystems.ThayDoiNN(this);
        }
        private void ucBaoCaoChenhLechDinhMuc_Load(object sender, EventArgs e)
        {
        ...
        private void InDuLieu()
        {
            ...
            Excel.Range title;
            int TCot = grvChenhLechDM.Columns.Count;
            int TDong = grvChenhLechDM.RowCount;
            int Dong = 1;
            excelApplication.Visible = false;
            grvChenhLechDM.ActiveFilter.Clear();
            grvChenhLechDM.ExportToXlsx(sPath);
