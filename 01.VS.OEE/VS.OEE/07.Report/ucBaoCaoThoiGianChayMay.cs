...
namespace VS.OEE
{
    public partial class ucBaoCaoThoiGianChayMay : DevExpress.XtraEditors.XtraUserControl
    {
        public ucBaoCaoThoiGianChayMay()
        {
            InitializeComponent();
            Commons.Modules.ObjSystems.ThayDoiNN(this);
        }
        private void ucBaoCaoThoiGianChayMay_Load(object sender, EventArgs e)
        {
        ...
        {
            if (grvThoiGianChayMay.RowCount == 0)
            {
        ...
        private void InDuLieu()
        {
            ...
            grvThoiGianChayMay.ActiveFilter.Clear();
            grvThoiGianChayMay.ExportToXlsx(sPath);
