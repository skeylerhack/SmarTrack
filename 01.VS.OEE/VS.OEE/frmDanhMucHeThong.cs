...
namespace VS.OEE
{
    public partial class frmDanhMucHeThong : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmDanhMucHeThong(int PQ)
        {
            ...
            Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "lblHeThong", Commons.Modules.TypeLanguage);
        ...
        private void StatusControl()
        {
            ...
            if (iMS_HE_THONG != -1)
            {
                txtMA_HE_THONG.ReadOnly = true;
            }
        }

        public void LoadNN()
        {
            lblMA_HE_THONG.Text = Commons.Modules.ObjLanguages.GetLanguage(this.Name, "lblMA_HE_THONG");
            lblTEN_HE_THONG.Text = Commons.Modules.ObjLanguages.GetLanguage(this.Name, "lblTEN_HE_THONG");
            lblTEN_HE_THONG_ANH.Text = Commons.Modules.ObjLanguages.GetLanguage(this.Name, "lblTEN_HE_THONG_ANH");
            lblTEN_HE_THONG_HOA.Text = Commons.Modules.ObjLanguages.GetLanguage(this.Name, "lblTEN_HE_THONG_HOA");
            lblSTT.Text = Commons.Modules.ObjLanguages.GetLanguage(this.Name, "lblSTT");
            lblNO_LINE.Text = Commons.Modules.ObjLanguages.GetLanguage(this.Name, "lblNO_LINE");
            lblTAI_LIEU.Text = Commons.Modules.ObjLanguages.GetLanguage(this.Name, "lblTAI_LIEU");
