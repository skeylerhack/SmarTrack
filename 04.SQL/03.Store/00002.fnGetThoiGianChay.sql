...
--lấy min ngày và max ngày của tiến độ
	...
	WHERE CONVERT(DATE,A.NGAY_DUNG) = CONVERT(DATE,@TuNgay) AND (B.MS_NGUYEN_NHAN != 14) AND A.MS_MAY = @MS_MAY) /*trừ ra thằng nào không có đơn hàng điều kiệu thời gian kết thúc không hớn hơn ngày*/
