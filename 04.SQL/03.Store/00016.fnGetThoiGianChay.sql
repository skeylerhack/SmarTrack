...
declare @Resulst DECIMAL(18,2);
	...
	SELECT (DATEDIFF(MINUTE,B.StartTime,B.EndTime) - ISNULL((SELECT SUM(A.THOI_GIAN_SUA_CHUA)  FROM dbo.THOI_GIAN_DUNG_MAY A
	...
	RETURN ISNULL(CASE @Resulst WHEN 0 THEN 1 ELSE CONVERT(DECIMAL(18,2),@Resulst/60) END	,1)
end
GO
